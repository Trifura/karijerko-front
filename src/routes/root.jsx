...
function Root() {
    ...
    return (
        <div className="relative">
            <Navbar />
            <div className="pt-32 px-10 lg:pt-56 bg-[#58CC02] flex justify-center flex-col gap-24 lg:gap-8 lg:flex-row pb-5">
                ...
                <div className="lg:w-1/3 flex flex-col items-end gap-3">
                    <div className="flex gap-3">
                        <div className="w-20 h-20 rounded-full border border-neutral-200 bg-white p-2 flex-none">
                            <img src={LogoShort}
                                 alt="Karijerko"
                                 className="w-full h-full"
                            />
                        </div>
                        <div className="text-base lg:text-lg font-medium px-5 py-3 border-2 border-neutral-200 rounded-r-3xl rounded-b-3xl w-full bg-white">
                            Bok, ja sam Karijerko. Predstavi mi se i uz moju pomoć pronađi najbolju kompaniju za sebe te unaprijedi svoje vještine!
                        </div>
                    </div>
                    <Link to="/mentor" className="text-base lg:text-lg px-4 py-2 font-semibold bg-white rounded-md border-2 border-neutral-200">
                        Započni razgovor
                    </Link>
                </div>
            </div>
            ...
            <hr className="bg-[#FFC800] h-4 rounded-full border-none w-32 lg:w-60 my-20 mx-auto"/>
            ...
            <div className="flex flex-col mx-8 items-center gap-12">
                ...
                <div className="bg-white mb-10 lg:mb-40 px-5 pt-4 pb-2 border-4 border-neutral-200 rounded-3xl lg:w-1/2 lg:h-[600px] flex flex-col justify-between gap-20">
            ...
            <div className="h-40 -z-10 lg:h-80 bg-[#58CC02] rounded-t-[40px] lg:rounded-t-[160px] absolute bottom-0 left-0 w-full">
            </div>
        </div>
    );
}
