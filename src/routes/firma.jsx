...
export default function Firma() {
    const company= {
        ...
        description: 'Treblle is an End to End API Platform. It empoveres companies looking to connect the dots between APIs and their business development.  \n' +
            '\n' +
            ...
            '\n' +
            ' EASY INTEGRATION\n' +
            'Treblle is a lightweight  SDK you add to your API in a few lines of code, currently supported for 20+ different languages and frameworks. \n' +
            ...
            <div className="px-6 py-3 flex flex-col gap-4 lg:gap-6">
                <div className="flex flex-col gap-2 lg:gap-3">
                    ...
                    <div className="flex flex-col text-sm lg:text-base font-medium">
                        <span>{company.industry.name_hr}</span>
