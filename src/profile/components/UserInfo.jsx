export default function UserInfo({ user, isPublic }) {
    ...
    const drawInitialsAvatar = (initials) => {
        ...
        const size = 80; // Width and height of the canvas
        canvas.width = size;
        canvas.height = size;
        ...
        <div className="p-8 flex flex-col lg:flex-row gap-5 justify-between">
            <div className="flex gap-4 items-center">
                {user.profilePicture ? (
                    ...
                    <img
                        src={drawInitialsAvatar(getInitials(user.firstName, user.lastName))}
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    {user.location && (
                        <div className="flex gap-1">
                            ...
                            <p className="text-base text-Ironside font-medium">
                                {user.location}, Hrvatska
                            </p>
                        </div>
                    )}
                </div>
